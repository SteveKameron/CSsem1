...
//определим тип с пространством имен
const string CalculatorTypeName = "CalculatorLib.Calculator";

string pathToDll = Path.Combine(Environment.CurrentDirectory, "Snippet07.dll");
UsingReflection(pathToDll);
UsingReflectionWithDynamic(pathToDll);
