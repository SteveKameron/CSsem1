...
namespace Lec06
{
    public static class Formula1
    {
        ...
        private static List<Racer> InitializeRacers() => new()
        {
            ...
            new("Fernando", "Alonso", "Spain", 345, 32, new int[] { 2005, 2006 }, new string[] { "Renault" }),
            ...
            new("Sebastian", "Vettel", "Germany", 287, 53, new int[] { 2010, 2011, 2012, 2013 }, new string[] { "Red Bull Racing" }),
            new("Nico", "Rosberg", "Germany", 207, 24, new int[] { 2016 }, new string[] { "Mercedes" }),
            new("Lewis", "Hamilton", "UK", 297, 103, new int[] { 2008, 2014, 2015, 2017, 2018, 2019, 2020 }, new string[] { "McLaren", "Mercedes" }),
            new("Max", "Verstappen", "Netherlands", 150, 26, new int[] { 2021 }, new string[] { "Red Bull Racing" })
        };
        ...
        public static IList<Racer> GetMoreRacers() => _moreRacers ??= new()
        {
            ...
            new Racer("Daniel", "Ricciardo", "Australia", Starts: 219, Wins: 8),
            new Racer("Valtteri", "Bottas", "Finland", Starts: 187, Wins: 10)
        };
