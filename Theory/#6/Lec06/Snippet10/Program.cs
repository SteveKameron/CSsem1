...
//Операции секционирования, такие как методы расширения Take и Skip, можно использовать для простого разбиения по страницам.
void Partitioning()
{
...
//пересечение запросов с локальной функцией
void SetOperations()
{
