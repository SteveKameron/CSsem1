...
void UseWriter()
{
    ...
    using (Utf8JsonWriter writer = new(stream, options))
    {
        ...
        writer.WriteString("Title", "Professional C# 8");
        writer.WriteString("Subtitle", "2022 Edition");
        writer.WriteEndObject();
        writer.WriteEndObject();
        writer.WriteStartObject();
        writer.WriteStartObject("Book");
        writer.WriteString("Title", "Professional C# 7");
        writer.WriteString("Subtitle", "2019 Edition");
        writer.WriteEndObject();
        writer.WriteEndObject();
