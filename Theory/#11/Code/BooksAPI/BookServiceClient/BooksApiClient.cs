...
public class BooksApiClient
{
    ...
    public async Task InitChaptersAsync()
    {
        Console.WriteLine(nameof(InitChaptersAsync));
        await _httpClient.GetAsync("init");
        Console.WriteLine("Books collection initiated");
        Console.WriteLine();
    }
